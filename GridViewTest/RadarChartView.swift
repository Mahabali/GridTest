...
public class RadarChartView: UIView {
    ...
    public var maxValue = CGFloat(5.0)
    public var verticalChartInset = CGFloat(40.0)
    public var horizontalChartInset = CGFloat(50.0)
  public var titleAttributes = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 12),
                                NSAttributedString.Key.foregroundColor: UIColor.black]
  public var webTitleAttributes = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 12),
                                   NSAttributedString.Key.foregroundColor: UIColor.black]
